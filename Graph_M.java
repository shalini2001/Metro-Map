...
import java.io.*;
	...
	public class Graph_M 
	{
		public class Vertex 
		{
			// Destination and weight from source to destination
			HashMap<String, Integer> nbrs = new HashMap<>();
		}

		// We use Hashmap to store the edges in the graph with source and destination
		...
		// We use addVertex when we are adding stations to vtces and the destination is set null
